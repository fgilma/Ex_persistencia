...
namespace Ex_Empleats.Controllers
{
    ...
    [ApiController]
    public class EmpleadoMySqlController : ControllerBase
    {
        private readonly MySqlContext _context;

        public EmpleadoMySqlController(MySqlContext context)
        {
            _context = context;
        }

        // GET: api/EmpleadoMySql
        [HttpGet]
